            ...
            <div class="legal-content">
                <div class="policy-hero-card">
                    <p>
                        ...
                        предоставляемые клиентами <strong><?= $domainTitle ?></strong> для оказания услуг по бизнес-консалтингу, аналитике и стратегическому планированию, а также для других взаимодействий в цифровом формате.
                    </p>
                </div>

                <div class="policy-notice">
                    <p>
                        <strong><?= $domainTitle ?></strong> оставляет за собой право вносить изменения в положения настоящей Политики. Предоставляя свои данные через сайт <strong><?= $fullDomain ?></strong>, вы даете полное согласие на их обработку способами, предусмотренными данным документом.
                    </p>
                </div>
                ...
                <div class="storage-info">
                    <div class="storage-item">
                        ...
                        <span>Срок хранения до <strong>75 лет</strong> (согласно архивному праву)</span>
                    </div>
                    <div class="storage-item">
                        <div class="storage-icon"><i data-lucide="user-check"></i></div>
                        <span>Только с вашего явного согласия</span>
                    </div>
                </div>
                <p>
                    Для предотвращения утечки данных мы используем передовую цифровую инфраструктуру и комплекс мер информационной безопасности. Уничтожение или блокирование данных осуществляется по первому запросу клиента.
                </p>
                ...
                <div class="data-collection-grid">
                    ...
                    <div class="data-box">
                        ...
                        <ul class="legal-list">
                            ...
                            <li>История запросов и оказанных услуг</li>
                        </ul>
                    </div>
                </div>
                ...
                <ul class="legal-list">
                    <li>Предоставление доступа к инновационной платформе консалтинга.</li>
                    <li>Учет ваших пожеланий при разработке новых решений и стратегий.</li>
                    <li>Информирование об актуальных инсайтах и материалах блога.</li>
                    <li>Обеспечение оперативной экспертной поддержки в Италии.</li>
                </ul>

                <h2>Использование Cookies</h2>
                <p>
                    Файлы cookie позволяют нам анализировать трафик и сохранять ваши предпочтения (например, региональные настройки Италии), чтобы сделать использование <strong><?= $fullDomain ?></strong> максимально эффективным.
                </p>

                <div class="rights-block">
                    <h2>Ваши права</h2>
                    <p>
                        Вы имеете право на редактирование данных или отзыв согласия. Свяжитесь с командой <strong><?= $domainTitle ?></strong> напрямую:
                    </p>
